...
package com.example.trainer.apprtc;
...
import com.example.trainer.Socket_service;
import com.example.trainer.apprtc.AppRTCAudioManager.AudioDevice;
import com.example.trainer.apprtc.AppRTCAudioManager.AudioManagerEvents;

import com.example.trainer.apprtc.PeerConnectionClient.DataChannelParameters;
import com.example.trainer.apprtc.PeerConnectionClient.PeerConnectionParameters;
    ...
    public boolean handleMessage(Message msg) {
      ...
      switch (msg.what) {
        case Socket_service.MSG_SEND_TO_ACTIVITY:
          ...
          if (value2.equals("cancel")){  disconnect(); }
